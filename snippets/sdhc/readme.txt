...
(3)change &sd status and sdmmc status both as disabled, same time change &emmc status and sdmmc status both as okay on sdk_glue/snippets/sdhc/boards/hpm6800evk.overlay
- board hpm6750evk2
(1)please add CONFIG_HPMICRO_BOARD_SUPPORT_EMMC=y on sdk_glue/snippets/sdhc/sdhc.conf